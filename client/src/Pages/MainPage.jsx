...
const handleCategoryChange = (category) => {
    ...
    return (
        <>
        <Navbar userRole={userRole} userUsername={profile?.username} onLogout={logout}/>
        ...
        <ItemListPage userRole={userRole || "guest"} profile={profile} searchTerm={searchTerm} selectedCategory={selectedCategory} /> 
